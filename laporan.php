...
$pesanan = query("SELECT * FROM tb_pesanan");
$dari_tgl="";
$sampai_tgl="";
    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="laporan.php">
                Laporan
              </a>
            </li>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h2 class="text-center"><b>Data Pesanan Pembeli</b></h2>
        </div>
        <form method="POST">
          <table>
            <td>Dari Tanggal</td>
        ...
        <?php
          if (isset($_POST["filter"]))
          {
            ...
            $pesanan = mysqli_query($conn, "SELECT * FROM tb_pesanan WHERE tanggal_pemesanan BETWEEN '$dari_tgl' AND '$sampai_tgl 23:59:59' " );
        ?>
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
              <h5>Dari Tanggal <?=date("d-m-Y", strtotime($dari_tgl))?> Sampai Tanggal <?=date("d-m-Y", strtotime($sampai_tgl))?></h5>
            </div>
            <?php } ?>
        ...
        <?php $i++; ?>
        <?php $totalharga+=$row["total_harga"]; ?>
        <?php endforeach; ?>
        </tbody>
        <tfoot>
          <tr>
        ...
        <form method="post" action="export.php">
          <center>
            ...
            <button type="submit" name="export" class="btn btn-success">Export Tabel Ini Sebagai Excel</button>
          </center>
        </form>
      </main>
    </div>
