...
if (isset($_POST["makan_di_tempat"])) {
  makan_di_tempat($_POST);
}

if (isset($_POST["antar_ke_rumah"])) {
  antar_ke_rumah($_POST);
}
?>
...
<html lang="en">
  ...
  <body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link js-scroll-trigger" href="keranjang.php">
                                Keranjang <span class="icon-button__badge"><?= $jml_keranjang ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container bg-light">
      <h3 class="text-center"><b>PESANAN ANDA</b></h3>
        <table class="table table-bordered" id="example">
          ...
          <tbody>
              ...
              <?php 
                $ambil = mysqli_query($conn, "SELECT * FROM tb_menu WHERE id_produk='$id_produk'");
        ...
        <form method="post" action="">
          <a href="index.php" class="btn btn-secondary">Lihat Menu Lain</a>
          <button class="btn btn-success" name="makan_di_tempat" 
          onclick="return confirm ('Apa Kamu Yakin Pesan Makanan Untuk Makan Di Tempat?');">Makan Di Tempat</button>
          <button class="btn btn-primary" name="antar_ke_rumah" 
          onclick="return confirm ('Apa Kamu Yakin Pesan Makanan Untuk Antar Ke Rumah?');">Antar Ke Rumah</button>
