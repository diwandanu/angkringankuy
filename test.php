      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="daftar_produk.php">
                Daftar Produk
              </a>
            </li>
            <li class="nav-item">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <?php foreach ($menu as $row) : ?>
          <tr>
            <td><?= $i; ?></td>
            <td> 
              <a href="ubah_produk.php?id_produk=<?=$row["id_produk"];?>"><i class="fas fa-edit fa-2x"></i></a> | 
            ...
            <td><img src="gambar/<?= $row["foto_produk"]; ?>" height="100px" width="100px"></td>
