        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h2 class="text-center"><b>Tambah Produk Baru</b></h2>
                </div>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="nama_produk">Nama Produk</label>
                        <input type="text" name="nama_produk" id="nama_produk" class="form-control" placeholder="" required autocomplete="off" onkeypress="return /[a-z ]/i.test(event.key)">
                    </div>
                    <div class="form-group">
                        <p>Kategori</p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="harga_produk" id="harga_produk" class="form-control" placeholder="" required autocomplete="off" onkeypress="return /[0-9]/i.test(event.key)"> 
                    </div>
                    <div class="form-group">
                        <label for="jumlah_produk">Jumlah Produk</label>
                        <input type="number" name="jumlah_produk" id="jumlah_produk" placeholder="" required autocomplete="off" min="1">
                    </div>
                    <div class=" form-group">
                        <label for="foto_produk">Foto Produk</label>
                        <input type="file" name="foto_produk" id="foto_produk" placeholder="" required autocomplete="off">
                    </div>
                    <button type="submit" name="submit" class="btn btn-primary" onclick="return confirm ('Apakah Data Produk Sudah Benar?');">Submit</button>
