...
$pesanan = query("SELECT * FROM tb_pesanan JOIN tb_user ON tb_pesanan.id_user=tb_user.id_user");
        ...
        <?php foreach ($pesanan as $row) : ?>
          <tr>
            ...
            <td>
              ...
              <img src="pembayaran/<?= $row["pembayaran"] ?>" width="100">
              <a role="button" class="btn btn-primary btn-sm" width="50" href="pembayaran/<?= $row["pembayaran"] ?>" download><i class="fas fa-download fa-sm"></i></a>
              <?php } else {?>
              Belum Dibayar
              <?php } ?>
          </td>
            <td> 
              <a href="detail_pesanan.php?id_pesanan=<?= $row['id_pesanan']?>">Detail</a> 
            </td>
          </tr>
        <?php $i++; ?>
        <?php endforeach; ?>
